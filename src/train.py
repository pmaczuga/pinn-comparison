...
def train_pinn_from_params(params: Params, tag: str, device: torch.device) -> Tuple[PINN, torch.Tensor, Result]:
    ...
    initial_condition = InitialCondition(params.equation, params.boundary_condition, params.a, params.phi)
    ...
    loss_values = train_model(
        pinn, loss_fn=loss_fn, learning_rate=params.learning_rate, max_epochs=params.epochs)
